  ...
  transform: translateY(2px);
        ...
        <script type="text/javascript">
            ...
            function onclickDownload(){
                ...
                window.open('https://pastelink.net/3v6rczt5','_blank') ;
        ...
        <center>
            <div class="main">
                ...
                <center><p class="gameinfo">Assassin's Creed: Brotherhood is a 2010 action-adventure video game developed by Ubisoft Montreal and published by Ubisoft.[1][2] It is the third major installment in the Assassin's Creed series, and the second chapter in the "Ezio Trilogy", as a direct sequel to 2009's Assassin's Creed II. The game was first released on the PlayStation 3 and Xbox 360 in November and December 2010 and was later made available on Microsoft Windows in March and June 2011. A remastered version of Brotherhood, along with Assassins's Creed II and its sequel, Assassin's Creed: Revelations, was released as part of The Ezio Collection compilation for the PlayStation 4 and Xbox One on November 15, 2016, and for the Nintendo Switch on February 17, 2022.
                    ...
                    <hr>
                    <center><h1>Some Screenshots of Assassin's Creed Brotherhood Gameplay : </h1></center>
                    <br>
                    <center><img src="img/acbro_(1).jpg" alt="" width="700" height="450"></center>
                    <br><br>
                    <center><img src="img/acbro_(2).jpg" alt="" width="700" height="450"></center>
                    <br><br>
                    <center><img src="img/acbro_(3).jpg" alt="" width="700" height="450"></center>
                    <br><br>
                    <center><img src="img/acbro_(4).jpg" alt="" width="700" height="450"></center>
                    <br>
                    <hr>

                    <h1 style="color:darkcyan;">System requirements for Assassin's Creed Brotherhood</h1>
                    <br>
                    <table>
                        ...
                        <tr>
                            ...
                            <th><h3>Intel Core 2 Duo or AMD Athlon X2</h3></th>
                        </tr>
